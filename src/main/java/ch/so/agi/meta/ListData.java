...
public class ListData {
    ...
    public List<Dataset> listData(Configuration config, UserSettings settings) {
        boolean failed = false;
        List<Dataset> dataMetadatav = new ArrayList<Dataset>();
        ...
        try {
            ...
            return dataMetadatav;
        }
        dataMetadatav = dataLister.getResult();
